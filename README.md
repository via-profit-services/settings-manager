...
Чтобы хранить глобальные настройки, необходимо созать их с каким-либо владельцем, в противном случае, настройка будет считаться _настройкой по умолчанию_ и будет создаваться для каждого пользователя
